...
#include "../linear equation system/LinearEquation.h"
#include "../linear equation system/LinearEquationClass.cpp"
#include "../linear equation system/SystemLinearEquation.h"
#include "../linear equation system/SystemLinearEquationClass.cpp"
	...
	public:
		...
		TEST_METHOD(CheckNoSolutions)
		{
			auto func = []()
			{
				int n = 2;
				SystemLinearEquation s(n);
				LinearEquation a1("-4.0, 2.0, 8.0");
				LinearEquation a2("-2.0, 1.0, 1.0");
				s.add(a1);
				s.add(a2);
				s.steppingUp();
				vector<double> solve1 = s.solveSystem();
		...
		TEST_METHOD(InfinitelyManySolutions)
		{
			auto func = []()
			{
				...
				LinearEquation a2("2.0, -2.0, 1.0");
				LinearEquation a3("6.0, -6.0, 3.0");
				s.add(a1);
				s.add(a2);
				s.steppingUp();
				vector<double> solve1 = s.solveSystem();
