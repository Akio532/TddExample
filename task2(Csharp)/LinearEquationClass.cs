...
namespace task2_Csharp_
{
    public class LinearEquationClass
    {
        ...
        public LinearEquationClass(string str)
        {
        ...
        public LinearEquationClass(LinearEquationClass le)
        {
            this.coefficients = (double[])le.coefficients.Clone();
        }

        public LinearEquationClass(int n)
        {
            if (n >= 2)
            {
        ...
        public LinearEquationClass(IList<double> list)
        {
            if (list.Count == 0)
            {
                this.coefficients = new double[] { 0, 0 };
        ...
        public static LinearEquationClass operator +(LinearEquationClass le1, LinearEquationClass le2)
        {
            int count = Math.Max(le1.coefficients.Length, le2.coefficients.Length);
            LinearEquationClass result = new LinearEquationClass(count);
        ...
        public static LinearEquationClass operator *(LinearEquationClass le, double k)
        {
            LinearEquationClass result = new LinearEquationClass(le);
        ...
        public static LinearEquationClass operator *(double k, LinearEquationClass le)
        {
            return le * k;
        }

        public static LinearEquationClass operator -(LinearEquationClass le)
        {
            return -1 * le;
        }

        public static bool operator ==(LinearEquationClass le1, LinearEquationClass le2)
        {
            int count = Math.Max(le1.coefficients.Length, le2.coefficients.Length);
            for (int i = 0; i < count; i++)
            {
        ...
        public static bool operator true(LinearEquationClass le)
        {
        ...
        public static bool operator false(LinearEquationClass le)
        {
        ...
        public static implicit operator double[](LinearEquationClass le)
        {
