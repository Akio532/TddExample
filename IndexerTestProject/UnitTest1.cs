...
namespace TestProject
{
    ...
    public class UnitTest1
    {
        ...
        {
            var indexer = new IndexerClass(array, 1, 2);
        ...
        {
            var indexer1 = new IndexerClass(array, 1, 2);
            var indexer2 = new IndexerClass(array, 0, 2);
            indexer1[0] = 100500;
        ...
        {
            Assert.Equals(typeof(ArgumentException), new IndexerClass(array, -1, 3));
        }
        ...
        {
            Assert.Equals(typeof(ArgumentException), new IndexerClass(array, 1, -1));
        }
        ...
        {
            Assert.Equals(typeof(ArgumentException), new IndexerClass(array, 1, 10));
        }
